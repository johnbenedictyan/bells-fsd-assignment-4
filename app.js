...
async function main() {
  ...
  app.get("/products", verifyToken, async function (req, res) {
    try {
      ...
      let { tags, category, name } = req.query;
  ...
  app.post("/products", async function (req, res) {
    try {
      ...
      let { name, category, price, description, tags } = req.body;
  ...
  // the user must provide an username and password
  app.post("/users", async function (req, res) {
    try {
      ...
      // if the request has both username and password
      let userDocument = {
        username,
  ...
  // the client is supposed to provide the username and password in req.body
    ...
    try {
      ...
      if (user) {
        ...
        if (bcrypt.compareSync(password, user.password)) {
          let accessToken = generateAccessToken(user._id, user.username);
          res.json({
